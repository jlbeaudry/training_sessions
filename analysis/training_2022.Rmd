---
title: "Training, Development and Communication 2022"
...
df <- read_xlsx(
  ...
  sheet = '2022 Program',
  skip = 7,
  n_max = 96, #last session to date is ECR Mentoring on Nov 23rd
  .name_repair = "unique",
  trim_ws = TRUE)
...
df_all <- df %>%
  select (c(Theme, `No. attended`, Session, Date, `Team / Provider`, `Presenter One`, `Presenter Two`)) %>%
