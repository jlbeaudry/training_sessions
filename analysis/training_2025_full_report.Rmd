...
df_sp <- read_xlsx(
  ...
  n_max = 90,  #last session is IP science & medicine
  .name_repair = "unique",
  trim_ws = TRUE)
...
attended in person (`r sum(n_event_sp$Attended_in_person)`) or online (
`r sum(n_event_sp$Attended_online)`). Although it is likely that the Flinders' 
research community prefer to meet face-to-face when possible, this in-person 
preference might be inflated by our team's decision to require people to attend an 
